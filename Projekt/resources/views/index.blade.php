...
<body>
    ...
    <section class="new-section container">
        <div class="heading">
    ...
    <section class="popular container" id="popular">
        <div class="heading">
            <h2 class="heading-title">Polecane Przez Urzytkowników</h2>
        </div>
        <div class="carousel-container">
            <div id="popularMoviesCarousel" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                    @php
                        $chunkedPopularMovies = $films->chunk(4);
                    @endphp
                    @foreach ($chunkedPopularMovies as $key => $movieGroup)
                        <li data-target="#popularMoviesCarousel" data-slide-to="{{ $key }}"
                            @if ($key == 0) class="active" @endif></li>
                    @endforeach
                </ol>
                <div class="carousel-inner">

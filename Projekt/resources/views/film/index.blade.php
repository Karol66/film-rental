...
@section('content')
    ...
    <div id="margin">
        <a href="{{ url('/film/create') }}" class="btn btn-success btn-sm" title="Add New Film">
                ...
                <tbody>
                    @foreach ($film as $item)
                        <tr>
                            ...
                            <td>{{ $item->number }}</td>
                            <td>
                                <a href="{{ url('/film/' . $item->id) }}" title="View Film">
                                ...
                                <a href="{{ url('/film/' . $item->id . '/edit') }}" title="Edit Film">
                                ...
                                <form method="POST" action="{{ url('/film' . '/' . $item->id) }}" accept-charset="UTF-8"
                                    ...
                                    <button type="submit" class="btn btn-danger btn-sm"
                                        title="Delete Film"onclick="return confirm(&quot;Confirm delete?&quot;)"><i

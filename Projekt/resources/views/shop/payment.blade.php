            ...
            <div class="col-lg-8">
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
                        <div class="image-container" style="cursor: pointer; border-radius: 10px; overflow: hidden;"
                ...
                <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 text-center">
                        <div class="image-container" style="cursor: pointer; border-radius: 10px; overflow: hidden;"
                            onclick="changeBorderColor(this)">
                            <img src="/img/paysafe.png" alt="Paysafe"
                                style="border-radius: 10px; width: 100%; height: 100%;">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div id="margin">
                    <form action="{{ route('shop.pay') }}" method="POST" onsubmit="return validatePaymentMethod()">
                        ...
                        <br>
                        <a href="{{ route('shop.create') }}" class="btn btn-danger" style="flex: 1; margin-left: 10px;">
                            <i class="bi bi-arrow-return-left"></i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-arrow-return-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                        ...
                        <div class="form-group">
                            <label for="id_adresses">Select Address:</label>
                            <select class="form-select" name="id_adresses" id="id_adresses">
